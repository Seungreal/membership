...
public class BoardViewer03 {
    ...
    private void selectOne(int index) {
        ...
        System.out.println("작성일: "+sdf.format(p.getWrittenDate().getTime()));
        System.out.println("수정일: "+sdf.format(p.getUpdatedDate().getTime()));
        System.out.println("------------");
    ...
    private void updateBoard(int index) {
        ...
        pArray[index].setUpdatedDate(Calendar.getInstance());
    }
