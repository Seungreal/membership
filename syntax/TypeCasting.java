...
//    우리가 특별히 아무런 일을 해주지 않아도 자동적으로 형변환이 된다
// 2. 명시적 형변환
//    명시적 형변황의 경우, 더 작은 데이터타입의 공간에 더 큰 데이터타입의 값을 담을때 발생한다
